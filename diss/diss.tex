...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\textcolor{red}{ROUGH DRAFT, PRE-SPELLCHECK}}
\rfoot{\thepage}
...
\node[box, minimum height = 4.2cm](b_listen)[below of = b_send_rpc, node distance=3cm]{Listen for\\incoming connnections};

\node[box, minimum height = 4.2cm](a_pre_listen)[left of = b_queue_entry, node distance=5cm]{Listen for\\incoming connnections};
...
\node[box](a_listen)[below of = a_send_success, node distance=1.5cm]{Listen for\\incoming connnections};
